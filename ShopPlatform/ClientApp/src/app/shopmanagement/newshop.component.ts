...
@Component({
  ...
  template: `
    <div class="row">
      ...
      <h4 class="mb-3" i18n="ShopInfoLabel| Information about shop">Shop information</h4>
      <div class="needs-validation">
        <div class="mb-3">
          <label for="firstName" i18n="ShopName|Shop Name">Shop name</label>
        ...
        <div class="mb-3">
          <label for="address" i18n="AddressLabel|Shop Address">Address</label>
          <input type="text" class="form-control" id="address" [(ngModel)]="shopAddress" placeholder="1234 Main St" required>
        ...
        <div class="row">
          <div class="col-md-5 mb-3">
            <label for="country" i18n="ContryLabel|Country label">Country</label>
            <select class="custom-select d-block w-100" id="country" [(ngModel)]="selectedCountry" required>
          ...
          <div class="col-md-4 mb-3">
            ...
            <input type="text" name="city" class="form-control" list="cityname" [(ngModel)]="selectedLocation" (ngModelChange)="loadCities($event)">
            <datalist id="cityname">
               <option *ngFor="let loc of locationsList">{{loc.locationName}}</option>
            </datalist>
            <div class="invalid-feedback">
...
export class NewshopComponent implements OnInit{
  ...
  loadCities(event: any): void{
    ...
    {
      this.httpClient.get(`/api/shop/location?cc=${this.selectedCountry.code}&kw=${event}`)
        .subscribe((data: any) => {
          this.locationsList = data.payload;
        });
    }
  }
  registerShop(): void{
